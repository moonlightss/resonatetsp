...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { Centre: @tutorial.Centre, address: @tutorial.address, name: @tutorial.name, phone: @tutorial.phone, website: @tutorial.website }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { Centre: @tutorial.Centre, address: @tutorial.address, name: @tutorial.name, phone: @tutorial.phone, website: @tutorial.website }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
